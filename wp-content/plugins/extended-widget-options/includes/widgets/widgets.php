...
function widgetopts_in_widget_form( $widget, $return, $instance ){
    ...
    $is_shortcodes  = ( isset( $widget_options['shortcodes'] ) ) ? $widget_options['shortcodes'] : '';
    ...
    <?php
    if( 'activate' == $is_shortcodes ){
        echo '<p class="widgetops-sc-opts">'. __( 'Shortcode:', 'widget-options' ) .'<br /><code>[do_widget id="'. $widget->id .'"]</code></p>';
    }
 }
